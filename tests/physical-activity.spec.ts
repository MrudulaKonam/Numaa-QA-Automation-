...
test.describe('PHYS - physical-activity', () => {
  ...
  test.skip('PHYS-04: Daily Vitals fields render with proper interactive controls', async ({ page }) => {
  ...
  test.skip('PHYS-05: "Sleep & Recovery" mood buttons render', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-06: "Physical Symptoms" checklist renders', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-08: "Session Preference" options render', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-09: "Details & Context" optional fields render', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-10: AI safety note renders', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-07: Selecting "None" is mutually exclusive with specific symptoms', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-11: "Create My Personalized Plan" generates a plan from the submitted data', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-12: "Save Draft" preserves in-progress answers', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-26: Full authenticated app sidebar renders consistently', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-25: Page <title> is unique to Physical Activity', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-21: "Daily Checklist" renders 3 items with category tags', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-23: "Hide checklist" toggle renders with a proper label', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-22: Checklist items can be marked complete', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-24: Hydration target is consistent with the Nutrition Agent — CRITICAL', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-01: Page loads with heading, description, and CTA', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-02: Feature name is consistent across the site', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-03: Generic "Chat" CTA has a descriptive accessible label', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-13: "Your Plan for Today" renders a recommended routine', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-15: 8 "Explore Exercises" cards render with trimester/category tags', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
...
(using the real video ID of whichever video someone has actually reviewed and approved)
  ...
  test.skip('PHYS-16: Carousel prev/next arrows have accessible labels', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-18: "Weekly Consistency" renders a 7-day calendar and streak', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-20: "Daily Steps" and "Streak" summary stats render', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
  ...
  test.skip('PHYS-19: Streak count is consistent with today's logged activity', async ({ page }) => {
    // TODO: implement navigation + assertions for this case
    // await page.goto('https://numaa.ai/...');
    // await expect(page.locator('...')).toBeVisible();
  });
